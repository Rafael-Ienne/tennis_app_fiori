		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#desafioesporte85appesporte-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"desafioesporte85appesporte-display": {
								"semanticObject": "desafioesporte85appesporte",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=desafioesporte85.appesporte",
									"url": sap.ui.require.toUrl("desafioesporte85/appesporte")
								}
							}
						}
					}
